            ...
            <div className='max-w-7xl mx-auto px-2 sm:px-2 lg:px-4'>
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-12'>
                    <motion.div initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.18 }} transition={{ duration: 0.6 }}>
                        <h2 className='text-3xl font-bold text-gray-800 mb-8'>leadership & <span className='text-yellow-500'>roles</span></h2>
                    ...
                    <motion.div initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.18 }} transition={{ duration: 0.6 }}>
                        <h2 className='text-3xl font-bold text-gray-800 mb-8'>international <span className='text-yellow-500'>certifications</span></h2>
                        <div className='space-y-6'>
