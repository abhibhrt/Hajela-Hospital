...
export default function AwardsGrid({ items = [] }) {
    ...
    Dr. Supriya Hajela - Award winning IVF Specialist in Bhopal recognized nationally and internationally for medical excellence in fertility treatments at Hajela Hospital.
</p>
                </motion.div>
