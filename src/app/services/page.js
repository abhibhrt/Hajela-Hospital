...
export const metadata = {
  ...
  keywords:
    "IVF treatment Bhopal, ICSI IUI services Bhopal, PGT testing MP, AI semen analysis, high risk pregnancy Bhopal, fertility specialist MP, best IVF center Madhya Pradesh, Dr. Supriya Hajela IVF, NABH accredited IVF, fertility doctor Bhopal, infertility treatment MP",
  authors: [{ name: "Dr. Supriya Hajela" }],
  openGraph: {
    title:
      "Best IVF & Fertility Treatments in Bhopal | Dr. Supriya Hajela - NABH Accredited",
    description:
      "Advanced IVF, ICSI, IUI, PGT services by award-winning specialist Dr. Supriya Hajela. 14+ years experience, high success rates at NABH hospital Bhopal",
    type: "website",
    locale: "en_IN",
  },
  robots: {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "NABH Accredited IVF and Fertility Centre in Bhopal, Madhya Pradesh offering advanced fertility treatments by Dr. Supriya Hajela",
              ...
              itemListElement: [
                {
                  ...
                  itemOffered: {
                    ...
                    name: "IVF Treatment",
                    description:
                      "In-vitro fertilization with advanced techniques at NABH accredited centre",
                  },
                },
                {
                  "@type": "Offer",
                  itemOffered: {
                    ...
                    description:
                      "Advanced male infertility procedures with high success rates",
                  },
                },
                {
                  "@type": "Offer",
                ...
                },
                {
                  ...
                  itemOffered: {
                    ...
                    description:
                      "Egg and embryo freezing with vitrification technology",
                  },
                },
              ],
            },
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-5">
          <div className="text-center max-w-4xl mx-auto animate-fade-in-up">
            ...
            <p className="text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
              Comprehensive <strong>fertility treatments and reproductive healthcare services</strong> with cutting-edge technology at{" "}
              <strong>NABH Accredited Hajela Hospital, Bhopal</strong>.{" "}
              <strong>Best IVF Center in Madhya Pradesh</strong> with 14+ years
              experience and high success rates under{" "}
              <strong>Dr. Supriya Hajela</strong>.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Why Choose{" "}
              <span className="text-pink-500">Hajela Hospital Bhopal</span>?
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Leading fertility center in <strong>Madhya Pradesh</strong> with
              advanced technology and expert care by{" "}
              <strong>Dr. Supriya Hajela</strong>
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              Comprehensive{" "}
              <span className="text-pink-500">Fertility Treatments in Bhopal</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              State-of-the-art <strong>reproductive medicine services</strong> with
              personalized care plans and the latest medical technology in{" "}
              <strong>Bhopal, Madhya Pradesh</strong> under expert guidance of{" "}
              <strong>Dr. Supriya Hajela</strong>
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div
                key={index}
                className="group relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 border-l-4 border-pink-500 animate-fade-in-up"
                style={{ animationDelay: `${index * 100}ms` }}
              >
                <div className="absolute -top-4 -right-4">
                  <div
                    className={`w-16 h-16 bg-gradient-to-r ${service.color} rounded-full flex items-center justify-center shadow-lg transform group-hover:scale-110 transition-transform duration-300`}
                  >
      ...
      <section className="py-16 bg-gradient-to-r from-pink-500 to-purple-500">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center animate-fade-in-up">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Consult with <strong>Dr. Supriya Hajela - Best IVF Specialist in
              Bhopal, MP</strong> at{" "}
            <strong>NABH Accredited Hajela Hospital</strong>
          </p>
          ...
          <p className="text-white/80 text-sm mt-6">
            NABH Accredited • 14+ Years Experience • 17000+ IVF Cycles • Best
            Fertility Center Bhopal
          </p>
        </div>
      </section>
    </>
