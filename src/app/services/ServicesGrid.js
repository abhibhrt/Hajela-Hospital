        ...
        <section className='py-16 bg-white'>
            <div className='max-w-7xl mx-auto px-2 sm:px-2 lg:px-4'>
                <motion.div initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.18 }} transition={{ duration: 0.6 }} className='text-center mb-12'>
                    ...
                    <p className='text-xl text-gray-600 max-w-3xl mx-auto'>state-of-the-art reproductive medicine services with personalized care plans and the latest medical technology</p>
                </motion.div>
                    ...
                    {items.map((service, index) => (
                        ...
                        >
                            ...
                            <div className='mt-6 pt-4 border-t border-gray-200'>
                                <button className='text-pink-500 text-sm font-semibold hover:underline group-hover:translate-x-1 transition-transform duration-300'>learn more →</button>
                            </div>
