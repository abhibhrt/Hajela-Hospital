        ...
        <div className='max-w-7xl mx-auto px-2 sm:px-2 lg:px-4 relative z-10'>
          ...
          >
            ...
            <p className='text-lg text-gray-700 max-w-3xl mx-auto'>
              Dr. Supriya Hajela - Award winning IVF Specialist in Bhopal recognized nationally for
              excellence in Fertility Treatments and Reproductive Medicine at Hajela Hospital.
            </p>
          </motion.div>
        ...
        <div className='max-w-4xl mx-auto px-2 sm:px-2 lg:px-4 text-center relative z-10'>
          <div className='bg-white rounded-2xl p-4 shadow-lg border border-gray-200'>
            ...
            <h2 className='text-3xl font-bold text-gray-900 mb-6'>
              My Mission &amp; Treatment Philosophy
            </h2>
            <p className='text-lg text-gray-700 leading-relaxed mb-6'>
              Dr. Supriya Hajela&apos;s mission - Every couple deserves parenthood. As the Best IVF
              Specialist in Bhopal, I provide compassionate fertility care with latest IVF
              technology at Hajela Hospital. Medical excellence with emotional support for your
              parenthood journey in Madhya Pradesh.
            </p>
            <div className='text-right'>
              <p className='text-blue-600 font-semibold'>
                - Dr. Supriya Hajela, IVF Specialist Bhopal
              </p>
            </div>
          </div>
        </div>
