                    ...
                    {items.map((skill, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <h3 className='text-xl font-semibold text-gray-900 mb-3 group-hover:text-blue-600 transition-colors'>{skill.title}</h3>
                                <p className='text-gray-700 leading-relaxed'>{skill.description}</p>
                                <div className='mt-4 pt-4 border-t border-gray-200'>
                                    <span className='text-blue-600 text-sm font-semibold group-hover:underline transition-all duration-300'>learn more &rarr;</span>
                                </div>
                            </motion.article>
                        )
                    })}
